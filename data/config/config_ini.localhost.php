...
$sys_info['server_headers'] = ['server' => 'Apache/2.4.51 (Win64) OpenSSL/1.1.1l PHP/8.0.12','x-powered-by' => 'PHP/8.0.12','x-is-http' => '1','content-length' => '0','content-type' => 'text/html; charset=UTF-8'];
